...
function TrendingProducts() {
  ...
  if (isLoading) return <div className="my-20">Loading trending products...</div>;
  if (error) return <div className="my-20">Error loading trending products</div>;
...
const TrendingProduct = ({
  ...
  return (
    <div className="flex-1 h-[450px] border-gray-300 rounded-t-lg bg-[#D9D9D912]/20">
      <img src={imgUrl} alt={name} className="w-full h-[280px] object-cover rounded-t-lg" />
